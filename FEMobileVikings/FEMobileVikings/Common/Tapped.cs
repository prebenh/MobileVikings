...
namespace FEMobileVikings.Common
{
    public sealed class Tapped
    {
        ...
        public static readonly DependencyProperty CommandProperty =
            DependencyProperty.RegisterAttached("Command", typeof(ICommand), typeof(Tapped), new PropertyMetadata(null, OnCommandChanged));
        ...
        public static readonly DependencyProperty CommandParameterProperty =
            DependencyProperty.RegisterAttached("CommandParameter", typeof(object), typeof(Tapped), new PropertyMetadata(null, OnCommandParameterChanged));
        ...
        private static readonly DependencyProperty HasCommandParameterProperty =
            DependencyProperty.RegisterAttached("HasCommandParameter", typeof(bool), typeof(Tapped), new PropertyMetadata(false));
        ...
        private static void OnCommandChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (element != null)
            {
                if (e.NewValue == null)
                {
                    element.Tapped -= FrameworkElementKeyUp;
                }
        ...
        private static void FrameworkElementKeyUp(object sender, TappedRoutedEventArgs e)
        {
